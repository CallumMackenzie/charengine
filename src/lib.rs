...
mod tests {
    ...
    impl State for App {
        fn initialize(&mut self, _win: &mut PlatformWindow) -> i32 {
            0
        }
        ...
        fn destroy(&mut self, _win: &mut PlatformWindow, exit_code: i32) {
    ...
    pub fn native_window_tests() {
        ...
        let window = PlatformWindow::create(&WindowCreateArgs::new(
            "CharEngine".into(),
            400,
            400,
